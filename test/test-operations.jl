...
@testitem "subgraph on CPDAG: chordal undirected component stays MPDAG" tags =
    [:unit, :operations] begin
...
@testitem "subgraph on MAG stays a (maximal) MAG" tags = [:unit, :operations] begin
...
@testitem "subgraph on PAG downgrades to UNKNOWN" tags = [:unit, :operations] begin
...
@testitem "subgraph on PAG: all-circle chain downgrades to UNKNOWN" tags =
    [:unit, :operations] begin
...
@testitem "dag_from_pdag does not fabricate a v-structure" tags = [:unit, :operations] begin
...
@testitem "condition_marginalize: marginalize yields bidirected edge" tags =
    [:unit, :operations] begin
...
@testitem "condition_marginalize: Figure 11 conditioning on S" tags = [:unit, :operations] begin
...
@testitem "markov_equivalent: v-structure vs chain is not equivalent" tags =
    [:unit, :operations] begin
...
@testitem "markov_equivalent: consistent with dag_to_cpdag" tags = [:unit, :operations] begin
...
@testitem "markov_equivalent (MAG): single-edge orientations are equivalent" tags =
    [:unit, :operations] begin
...
@testitem "CausalEdge: symmetric edges are stored in canonical order" tags =
    [:unit, :operations] begin
